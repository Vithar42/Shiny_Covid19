...
* Testing
  ...
  + Total positive: **`r prettyNum(dataWidePlain$Total.cases, big.mark=",")`** (up `r (dataWidePlain$New.cases)`)
* Case info   
  + Patients who are currently sick: **`r prettyNum(dataWidePlain$Currently.sick, big.mark=",")`** (`r (ifelse(dataWidePlain$New.sick <0, sprintf("down"), sprintf("up")))` `r (abs((dataWidePlain$New.sick)))`)
